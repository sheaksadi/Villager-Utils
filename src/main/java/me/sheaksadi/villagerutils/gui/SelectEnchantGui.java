...
public class SelectEnchantGui extends LightweightGuiDescription {
    public SelectEnchantGui() {
        ...
        WLabel label = new WLabel(Text.of("Select Enchantments"), 0x00E676);
...
//        }
        ...
        BiConsumer<Enchantment, EnchantPanel> configurator = (Enchantment enchantment, EnchantPanel ePanel) -> {
            ePanel.button.setLabel(Text.translatable(enchantment.getName(enchantment.getMaxLevel()).getString()));
...
//        root.add(button, 0, 3, 4, 1);
        ...
        WToggleButton tButton = new WToggleButton(Text.of("Search for max level"));
